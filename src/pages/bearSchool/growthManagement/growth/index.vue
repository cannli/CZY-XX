      ...
      <el-row class="tip_pro backg-bor-style" :gutter="40">
        <el-col :xs="8" :sm="8" :lg="8" style="padding-top: 20px;">
          ...
          <div class="">
            ...
            <div style="max-width: 360px;min-width:120px;margin:15px auto; font-size: 14px;">本次检测为本年度第{{baseInfo.rank}}次检测，对比统计已出。</div>

            <div style="max-width: 360px;min-width:120px;margin:15px auto;font-size: 14px;" v-if="baseInfo.isReport">专家定制报告已出。</div>
            <div style="max-width: 360px;min-width:120px;margin:15px auto;font-size: 14px;" v-if="baseInfo.isReport==false">专家定制报告仍在审核，预计三日后可查看。</div>
